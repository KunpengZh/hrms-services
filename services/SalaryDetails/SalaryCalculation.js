...
const NotApplicableNonRegularEmpColumns = ['jinengGongzi', 'gangweiGongzi', 'jichuButie', 'xilifei',
    'gonglingGongzi', 'jibengongzi', 'zhiwuJintie', 'gongliBuzhu', 'kaoheJiangjin', 'tongxunButie',
    'qitaJiangjin', 'xiaxiangBuzhu', 'yingyetingBuzhu', 'NormalOT', 'NormalOTComments',
    'WeekendOT', 'WeekendOTComments', 'HolidayOT', 'HolidayOTComments', 'kouchu', 'kaohekoukuan', 'zhufanggongjijin',
...
const SharedFields = ['idCard', 'bankAccount', 'birthday', 'preAnnuallyIncom', 'nianjinJishu',
    'shiyebaoxianJishu', 'yanglaobaoxianJishu', 'zhufanggongjijinJishu']
...
SalaryCalculation.calculateJibengongzi = function (emps) {
    ...
    for (let i = 0; i < emps.length; i++) {
        ...
        if (emp.workerCategory.trim() === NonRegularEmployeeCategory) {
             ...
             */
            emp.jibengongzi = keepTwoDecimalFull(parseFloat(emp.jinengGongzi)
                + parseFloat(emp.gangweiGongzi)
                + parseFloat(emp.jichuButie)
                + parseFloat(emp.xilifei)
                + parseFloat(emp.gonglingGongzi)) + '';
            emp.jibengongziComments = "技能工资(" + emp.jinengGongzi
                + ")+岗位工资(" + emp.gangweiGongzi
                + ")+基础补贴(" + emp.jichuButie
                + ")+洗理费(" + emp.xilifei
                + ")+工龄工资(" + emp.gonglingGongzi
                + ")=" + emp.jibengongzi;
...
SalaryCalculation.categoryOT = function (emps, configDoc) {
    ...
    let newemps = emps.map(function (emp) {
        if (emp.workerCategory.trim() === NonRegularEmployeeCategory) {
            ...
            emp.HolidayOT = Math.round((parseFloat(emp.jinengGongzi) + parseFloat(emp.gangweiGongzi)) / 21.75 * 2 * parseFloat(emp.HolidayOT));
...
SalaryCalculation.calculateYingfagongzi = function (emps) {
    let newemps = emps.map(function (emp) {
        if (emp.workerCategory.trim() === NonRegularEmployeeCategory) {
            ...
            emp.yingfagongzi = keepTwoDecimalFull(parseFloat(emp.jibengongzi)
                + parseFloat(emp.anquanJiangli)
                + parseFloat(emp.wuweizhangJiangli)
                + parseFloat(emp.OTJiangjin));

            emp.yingfagongziComments = "基本工资(" + emp.jibengongzi
                + ")+安全奖励(" + emp.anquanJiangli
                + ")+无违章奖励(" + emp.wuweizhangJiangli
                + ")+加班奖金(" + emp.OTJiangjin
                + ")=应发工资(" + emp.yingfagongzi
                + ")";
        } else {
            /**
             * 全日制员工
            ...
            emp.yingfagongziComments = "基本工资(" + emp.jibengongzi
                + ")+职务津贴(" + emp.zhiwuJintie
                + ")+公里补助(" + emp.gongliBuzhu
                + ")+考核奖金(" + emp.kaoheJiangjin
                + ")+固定奖金(" + emp.gudingJiangjin
                + ")+通讯补贴(" + emp.tongxunButie
                + ")+其他奖励(" + emp.qitaJiangjin
                + ")+下乡补助(" + emp.xiaxiangBuzhu
                + ")+营业厅补助(" + emp.yingyetingBuzhu
                + ")+平时加班(" + emp.NormalOT
                + ")+周末加班(" + emp.WeekendOT
                + ")+节假日加班(" + emp.HolidayOT
                + ")-扣除项(" + emp.kouchu
                + ")-考核扣款(" + emp.kaohekoukuan
                + ")=应发工资(" + emp.yingfagongzi
                + ")";
        }
...
SalaryCalculation.calculateNianJinAndBaoXian = function (emps, configDoc) {
    ...
    let newemps = emps.map(function (emp) {
        ...
        if (emp.workerCategory.trim() === NonRegularEmployeeCategory) {
            ...
            emp.nianjinComments = preComments + '上一年度月平均收入(' + nianjinJishu + ')*年金系数(' + nianjinxishu + ')=' + emp.nianjin;
            emp.yanglaobaoxianComments = preComments + '上一年度月平均收入(' + yanglaobaoxianJishu + ')*养老保险系数(' + yanglaobaoxianxishu + ')=' + emp.yanglaobaoxian;
            emp.shiyebaoxianComments = preComments + '上一年度月平均收入(' + shiyebaoxianJishu + ')*失业保险系数(' + shiyebaoxianxishu + ')=' + emp.shiyebaoxian;
            /**
             * 企业部分
             */
            emp.qiyeNianjin = keepTwoDecimalFull(nianjinJishu * qiyenianjinxishu);
            emp.qiyeNianJinComments = preComments + '上一年度月平均收入(' + nianjinJishu + ')*企业年金系数(' + qiyenianjinxishu + ')=' + emp.qiyeNianjin;
            ...
            emp.qiyeYanglaobaoxianComments = preComments + '上一年度月平均收入(' + yanglaobaoxianJishu + ')*企业养老保险系数(' + qiyeyanglaobaoxianxishu + ')=' + emp.qiyeYanglaobaoxian;
            ...
            emp.qiyeShiyebaoxianComments = preComments + '上一年度月平均收入(' + shiyebaoxianJishu + ')*企业失业保险系数(' + qiyeshiyebaoxianxishu + ')=' + emp.qiyeShiyebaoxian;
            ...
            */
            ...
            emp.yanglaobaoxianComments = preComments + '上一年度月平均收入(' + yanglaobaoxianJishu + ')*养老保险系数(' + yanglaobaoxianxishu + ')=' + emp.yanglaobaoxian;
            emp.shiyebaoxianComments = preComments + '上一年度月平均收入(' + shiyebaoxianJishu + ')*失业保险系数(' + shiyebaoxianxishu + ')=' + emp.shiyebaoxian;
            emp.zhufanggongjijinComments = preComments + '上一年度月平均收入(' + zhufanggongjijinJishu + ')*住房公积金系数(' + zhufanggongjijinxishu + ')=' + emp.zhufanggongjijin;
            ...
            emp.qiyeZhufanggongjijinComments = preComments + '上一年度月平均收入(' + zhufanggongjijinJishu + ')*企业住房公积金系数(' + qiyezhufanggongjijinxishu + ')=' + emp.qiyeZhufanggongjijin;
...
SalaryCalculation.baoxianbulvData = function (emps, bulvData) {
    let newemps = emps.map(function (emp) {
        ...
        if (bulvEmp.qiyeShiyebaoxian && parseFloat(bulvEmp.qiyeShiyebaoxian) > 0) {
            emp.qiyeShiyebaoxian = keepTwoDecimalFull(parseFloat(emp.qiyeShiyebaoxian) + parseFloat(bulvEmp.qiyeShiyebaoxian));
        ...
        if (bulvEmp.qiyeYanglaobaoxian && parseFloat(bulvEmp.qiyeYanglaobaoxian) > 0) {
            emp.qiyeYanglaobaoxian = keepTwoDecimalFull(parseFloat(emp.qiyeYanglaobaoxian) + parseFloat(bulvEmp.qiyeYanglaobaoxian));
        ...
        if (emp.workerCategory.trim() === NonRegularEmployeeCategory) {
            ...
            */
            ...
            if (bulvEmp.zhufanggongjijin && parseFloat(bulvEmp.zhufanggongjijin) > 0) {
                emp.zhufanggongjijin = keepTwoDecimalFull(parseFloat(emp.zhufanggongjijin) + parseFloat(bulvEmp.zhufanggongjijin));
            ...
            if (bulvEmp.qiyeZhufanggongjijin && parseFloat(bulvEmp.qiyeZhufanggongjijin) > 0) {
                emp.qiyeZhufanggongjijin = keepTwoDecimalFull(parseFloat(emp.qiyeZhufanggongjijin) + parseFloat(bulvEmp.qiyeZhufanggongjijin));
                emp.qiyeZhufanggongjijinComments += ' + 本月补录数据(' + bulvEmp.qiyeZhufanggongjijin + ')=' + emp.qiyeZhufanggongjijin;
            ...
            if (bulvEmp.qiyeYiliaobaoxian && parseFloat(bulvEmp.qiyeYiliaobaoxian) > 0) {
                ...
                emp.qiyeYiliaobaoxian = keepTwoDecimalFull(parseFloat(emp.qiyeYiliaobaoxian) + parseFloat(bulvEmp.qiyeYiliaobaoxian));
...
SalaryCalculation.calculateYingshuigongzi = function (emps, configDoc) {
    ...
    let newemps = emps.map(function (emp) {
        ...
        if (emp.workerCategory.trim() === NonRegularEmployeeCategory) {
             ...
             */
            let yingshuigongzi = parseFloat(emp.yingfagongzi)
            ...
            emp.yingshuigongziComments = '应发工资(' + emp.yingfagongzi
                + ")+企业年金(" + emp.qiyeNianjin
                + ")-养老保险(" + emp.yanglaobaoxian
                + ")-失业保险(" + emp.shiyebaoxian
                + ')-个人所得税税基(' + gerensuodeshuishuiji + ')=' + emp.yingshuigongzi;
        } else {
            /**
            * 全日制员工
            * 个人的年金和补充医疗保险为什么要在税后扣除？
            ...
            */
            ...
            emp.yingshuigongziComments = "应发工资(" + emp.yingfagongzi
                ...
                + ")-养老保险(" + emp.yanglaobaoxian
                + ")-失业保险(" + emp.shiyebaoxian
                + ")-医疗保险(" + emp.yiliaobaoxian
                + ")-住房公积金(" + emp.zhufanggongjijin
                + ")-通讯补贴(" + emp.tongxunButie
                + ")-个人所得税税基(" + gerensuodeshuishuiji + ")=" + emp.yingshuigongzi;
        }
...
SalaryCalculation.calculateNetIncome = function (emps) {
    for (let i = 0; i < emps.length; i++) {
        ...
        if (emp.workerCategory.trim() === NonRegularEmployeeCategory) {
            ...
            let netIncome = parseFloat(emp.yingfagongzi)
                - parseFloat(emp.nianjin)
                - parseFloat(emp.yanglaobaoxian)
                - parseFloat(emp.shiyebaoxian)
                - parseFloat(emp.tax);
            ...
            emps[i].netIncomeComments = "应发工资(" + emp.yingfagongzi
                + ")-年金(" + emp.nianjin
                + ")-养老保险(" + emp.yanglaobaoxian
                + ")-失业保险(" + emp.shiyebaoxian
                + ")-个人所得税(" + emp.tax
            ...
            emps[i].netIncomeComments = "应发工资(" + emp.yingfagongzi
                ...
                + ")-医疗保险(" + emp.yiliaobaoxian
                + ")-个人所得税(" + emp.tax
                + ")+一次性奖金(" + emp.yicixingjiangjin
                + ")-一次性奖金税(" + emp.yicixingjiangjinTax
                + ") = " + keepTwoDecimalFull(netIncome);
